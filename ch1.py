...
class BlockChain:
    ...
    def transaction_to_string(self, transaction):
        transaction_dict = {"sender": str(transaction.sender), "receiver": str(transaction.receiver),
                            "amounts": transaction.amounts, "fee": transaction.fee, "message": transaction.message}
    ...
    def create_genesis_block(self):
        ...
        new_block = Block("Hello the world of BlockChain", self.difficulty, "TonySu", self.miner_rewards)
...
if __name__ == "__main__":
    ...
    block.mine_block("TonyGO")

    block.verify_blockchain()

    print("Insert fake transaction.")
    fake_transaction = Transaction("test123", "tommy", 100, 1, "test")
